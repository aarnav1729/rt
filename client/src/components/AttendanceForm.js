...
const AttendanceForm = ({ members, attendance, onAttendanceChange, onSubmit, selectedEvent }) => {
  ...
  const handleAddMember = async () => {
    ...
    try {
      await axios.post('/api/attendance/addMember', { ...newMember, eventId: selectedEvent });
